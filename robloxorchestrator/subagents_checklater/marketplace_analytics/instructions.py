...
- Tracking game passes and monetization strategies
...
- Game pass data for analyzing monetization strategies
- Game pass pricing and categorization analytics
...
4. **Game Pass Analytics**: Track monetization strategies
   - track_game_passes(): Analyze game passes for specific games
   - compare_game_pass_strategies(): Compare monetization across games
   - analyze_game_pass_trends(): Track changes in monetization over time
...
- "Analyze game passes for Adopt Me" → Use track_game_passes()
- "Compare monetization strategies between top games" → Use compare_game_pass_strategies()
- "Which games have the most expensive game passes?" → Use track_game_passes()
